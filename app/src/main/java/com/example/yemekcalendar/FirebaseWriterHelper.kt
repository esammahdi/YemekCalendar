...
val roomCalendarDayEntities: List<com.example.yemekcalendar.core.data.room.entities.CalendarDayEntity> =
    generateRandomCalendarDays(foodItemsExamples).map { calendarDay ->
        toRoomCalendarDayEntity(calendarDay)
    }

fun toRoomCalendarDayEntity(calendarDay: CalendarDayEntity): com.example.yemekcalendar.core.data.room.entities.CalendarDayEntity {
    ...
    return com.example.yemekcalendar.core.data.room.entities.CalendarDayEntity(
        institution = "Marmara",
